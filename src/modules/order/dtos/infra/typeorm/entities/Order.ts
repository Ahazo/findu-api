import Bundle from '../../../../../bundle/infra/http/typeorm/repositories/entities/Bundle';
...
export default class Order {
  ...
  @OneToMany(() => DeliveryAgreement, ( deliveryAgreement: DeliveryAgreement) => deliveryAgreement.order)

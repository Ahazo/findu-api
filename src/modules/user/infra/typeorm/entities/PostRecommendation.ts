...
export default class PostRecommendation {
	...
	@ManyToOne(() => Freelancer, (freelancer: Freelancer) => freelancer.postRecommendation)
	@JoinColumn({name: 'freelancer_id'})
	freelancer: Freelancer;

	@OneToMany(() => Recommendation, (recommendation: Recommendation) => recommendation.postRecommendation)
